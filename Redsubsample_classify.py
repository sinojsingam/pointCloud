...
classified_pointCloudPath = None #change
nonClassified_pointCloudPath = None #change
#create output txt files
outputErrorRF = '../results/error_RF_multi_reduced.txt'
outputErrorSVM = '../results/error_SVM_multi_reduced.txt'
...
send_email.sendUpdate('Evaluating done and saved as txt files. Now predicting...')
